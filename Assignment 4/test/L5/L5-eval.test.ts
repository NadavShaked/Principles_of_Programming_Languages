...
import { isNumExp, isBoolExp, isVarRef, isPrimOp, isProgram, isDefineExp, isVarDecl,
         ...
         parseL5Exp, unparse, Exp, parseL5, isLetValuesExp } from "../../part2/L5-ast";
import { Result, bind, isOkT, makeOk, isFailure } from "../../shared/result";
import { parse as parseSexp } from "../../shared/parser";
import { evalParse, evalProgram } from "../../part2/L5-eval";
import { makeSymbolSExp, makeCompoundSExp, makeEmptySExp, isClosure, makeTupleSExp } from "../../part2/L5-value";
...
describe('L5 Eval', () => {
    ...
    describe('Primitive Procedures', () => {
        ...
        it('evaluates "values"', () => {
            expect(evalParse("(values 1 2 #t)")).to.deep.equal(makeOk(makeTupleSExp([1,2, true])));
...
//added  example 3 with value
    it('evaluates "define" expressions', () => {
        ...
        expect(bind(parseL5("(L5 (define x (values 1 2 3)) x)"), evalProgram)).to.deep.equal(makeOk(makeTupleSExp([1,2,3])));
